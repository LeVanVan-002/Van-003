...
<link rel="stylesheet" id="login-css" href="https://levanvan-002.github.io/Van-003/wp-admin/css/login.min.css?ver=5.7.2" type="text/css" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="https://levanvan-002.github.io/Van-003/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
									<input type="hidden" name="redirect_to" value="https://levanvan-002.github.io/Van-003/wp-admin/">
